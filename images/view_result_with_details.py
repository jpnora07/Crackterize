...
class result_with_details(object):
    def setupUi(self, Dialog):
        ...
        self.print1.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("printer.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def view_details_function(self):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("editor.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)

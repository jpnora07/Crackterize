...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy.setHeightForWidth(self.Dia_lineEdit.sizePolicy().hasHeightForWidth())
        self.Dia_lineEdit.setSizePolicy(sizePolicy)
        self.Dia_lineEdit.setMinimumSize(QtCore.QSize(0, 0))

...
class Ui_Dialog(object):
    ...
    def concrete_function(self):
        try:
            ...
            Crack_Line_Length = os.path.join(app_path, 'concreteCalculator.py')
    ...
    def curbgutter_function(self):
        try:
            ...
            # Create the path to the result.py file
            Crack_Line_Length = os.path.join(app_path, 'curb&gutterCalc.py')
            # Execute the result.py file using QProcess
            process = QtCore.QProcess()
            process.start('python', [Crack_Line_Length])
    ...
    def slabssquare_function(self):
        try:
            ...
            # Create the path to the result.py file
            Crack_Line_Length = os.path.join(app_path, 'slabs_wallsfootings.py')
            # Execute the result.py file using QProcess
            process = QtCore.QProcess()
            process.start('python', [Crack_Line_Length])
    ...
    def holecolumn_function(self):
        try:
            ...
            # Create the path to the result.py file
            Crack_Line_Length = os.path.join(app_path, 'holecolumn.py')
            # Execute the result.py file using QProcess
            process = QtCore.QProcess()
            process.start('python', [Crack_Line_Length])
    ...
    def circularslab_function(self):
        try:
            ...
            # Create the path to the result.py file
            Crack_Line_Length = os.path.join(app_path, 'circularslabcalc.py')
            # Execute the result.py file using QProcess
            process = QtCore.QProcess()
            process.start('python', [Crack_Line_Length])

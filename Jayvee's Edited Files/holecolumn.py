...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.Quantity_lineEdit = QtWidgets.QLineEdit(self.widget_7)
        self.Quantity_lineEdit.setObjectName("Quantity_lineEdit")
        self.horizontalLayout_3.addWidget(self.Quantity_lineEdit)
        ...
        self.result.setGeometry(QtCore.QRect(10, 30, 291, 51))
    ...
    def calculate(self):
        try:
            ...
            self.result.setStyleSheet("font-size: 5pt; font-family: Inter; font-weight: Bold; ")
